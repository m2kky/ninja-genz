...
- [Operations Documentation — Ninja Gen Z Platform](#operations-documentation--ninja-gen-z-platform)
  - [TL;DR](#tldr)
  - [Table of Contents](#table-of-contents)
  - [1. Deployment Procedures](#1-deployment-procedures)
    - [1.1 Staging Deployment](#11-staging-deployment)
    - [1.2 Production Deployment](#12-production-deployment)
  - [2. Database Migration Guide](#2-database-migration-guide)
    - [2.1 Creating Migrations](#21-creating-migrations)
    - [2.2 Applying Migrations](#22-applying-migrations)
    - [2.3 Migration Rollback](#23-migration-rollback)
  - [3. Rollback Procedures](#3-rollback-procedures)
    - [3.1 Frontend Rollback (Vercel)](#31-frontend-rollback-vercel)
    - [3.2 Database Rollback](#32-database-rollback)
  - [4. Incident Response Runbook](#4-incident-response-runbook)
    - [4.1 Incident Severity Levels](#41-incident-severity-levels)
    - [4.2 P0 Incident Response (Platform Down)](#42-p0-incident-response-platform-down)
  - [5. Monitoring \& Alerting](#5-monitoring--alerting)
    - [5.1 Metrics to Monitor](#51-metrics-to-monitor)
    - [5.2 Alert Configuration](#52-alert-configuration)
  - [6. Backup \& Recovery](#6-backup--recovery)
    - [6.1 Automated Backups](#61-automated-backups)
