...
- [AI Context Files \& Prompts — Ninja Gen Z Platform](#ai-context-files--prompts--ninja-gen-z-platform)
  - [TL;DR](#tldr)
  - [Table of Contents](#table-of-contents)
  - [1. Cursor IDE Configuration](#1-cursor-ide-configuration)
    - [1.1 Codebase Rules File](#11-codebase-rules-file)
    - [4. RTL Layout (Arabic Support)](#4-rtl-layout-arabic-support)
  ...
  - [Example: Generate Task Component](#example-generate-task-component)
    - [2.2 Form Component Prompt](#22-form-component-prompt)
